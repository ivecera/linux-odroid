...
enum qcom_platform {
	QCOM_HW_PLATFORM_UNKNOWN	= 0,
	QCOM_HW_PLATFORM_SURF		= 1,
	QCOM_HW_PLATFORM_FFA		= 2,
	QCOM_HW_PLATFORM_FLUID		= 3,
	QCOM_HW_PLATFORM_SVLTE_FFA	= 4,
	QCOM_HW_PLATFORM_SVLTE_SURF	= 5,
	QCOM_HW_PLATFORM_MTP_MDM	= 7,
	QCOM_HW_PLATFORM_MTP		= 8,
	QCOM_HW_PLATFORM_LIQUID		= 9,
	QCOM_HW_PLATFORM_DRAGON		= 10,
	QCOM_HW_PLATFORM_QRD		= 11,
	QCOM_HW_PLATFORM_HRD		= 13,
	QCOM_HW_PLATFORM_DTV		= 14,
	QCOM_HW_PLATFORM_RCM		= 21,
	QCOM_HW_PLATFORM_STP		= 23,
	QCOM_HW_PLATFORM_SBC		= 24,
	QCOM_HW_PLATFORM_ADP		= 25,
	QCOM_HW_PLATFORM_TTP		= 30,
	QCOM_HW_PLATFORM_HDK		= 31,
	QCOM_HW_PLATFORM_E2		= 32,
	QCOM_HW_PLATFORM_SIRIUS		= QCOM_HW_PLATFORM_E2,
	QCOM_HW_PLATFORM_F2		= 34,
	QCOM_HW_PLATFORM_GRUS		= QCOM_HW_PLATFORM_F2,
	QCOM_HW_PLATFORM_F3B		= 35,
	QCOM_HW_PLATFORM_PYXIS		= QCOM_HW_PLATFORM_F3B,
	QCOM_HW_PLATFORM_F3M		= 38,
	QCOM_HW_PLATFORM_VELA		= QCOM_HW_PLATFORM_F3M,
	QCOM_HW_PLATFORM_INVALID
};
