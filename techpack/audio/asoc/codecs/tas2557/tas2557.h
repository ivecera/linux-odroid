...
#define TAS2557_DAC_GAIN_MASK  (0x0f << TAS2557_DAC_GAIN_SHIFT)
...
#define TAS2557_TEST_MODE_MASK	 0x0f

/* B0P253R71 - TAS2557_CRYPTIC_REG */
#define TAS2557_OSC_TRIM_CAP(x)	   ((x)&0x3f)
#define TAS2557_DISABLE_ENCRYPTION BIT(6)
#define TAS2557_SL_COMP		   BIT(7)
...
#define TAS2557_FORMAT_SHIFT	5
#define TAS2557_FORMAT_I2S	(0x0 << TAS2557_FORMAT_SHIFT)
#define TAS2557_FORMAT_DSP	(0x1 << TAS2557_FORMAT_SHIFT)
#define TAS2557_FORMAT_RIGHT_J	(0x2 << TAS2557_FORMAT_SHIFT)
#define TAS2557_FORMAT_LEFT_J	(0x3 << TAS2557_FORMAT_SHIFT)
#define TAS2557_FORMAT_MONO_PCM (0x4 << TAS2557_FORMAT_SHIFT)
#define TAS2557_FORMAT_MASK	(0x7 << TAS2557_FORMAT_SHIFT)

#define TAS2557_WORDLENGTH_SHIFT 3
#define TAS2557_WORDLENGTH_16BIT (0x0 << TAS2557_WORDLENGTH_SHIFT)
#define TAS2557_WORDLENGTH_20BIT (0x1 << TAS2557_WORDLENGTH_SHIFT)
#define TAS2557_WORDLENGTH_24BIT (0x2 << TAS2557_WORDLENGTH_SHIFT)
#define TAS2557_WORDLENGTH_32BIT (0x3 << TAS2557_WORDLENGTH_SHIFT)
...
#define TAS2557_PLL_J_VAL_MASK	((u32)(0x7f << 0))
...
#define TAS2557_DSP_CLK_FROM_PLL BIT(5)
...
struct tas2557_priv {
	...
	u32		  mnCurrentProgram;
	u32		  mnCurrentSampleRate;
	u32		  mnNewConfiguration;
	u32		  mnCurrentConfiguration;
	u32		  mnCurrentCalibration;
	u8		  mnCurrentBook;
	u8		  mnCurrentPage;
	bool		  mbTILoadActive;
	bool		  mbPowerUp;
	...
	int (*read)(struct tas2557_priv *pTAS2557, u32 reg, u32 *pValue);
	int (*write)(struct tas2557_priv *pTAS2557, u32 reg, u32 Value);
	int (*bulk_read)(struct tas2557_priv *pTAS2557, u32 reg, u8 *pData,
			 u32 len);
	int (*bulk_write)(struct tas2557_priv *pTAS2557, u32 reg, u8 *pData,
			  u32 len);
	int (*update_bits)(struct tas2557_priv *pTAS2557, u32 reg, u32 mask,
			   u32 value);
	...
	u32		   mnDevGain;
	u32		   mnDevCurrentGain;
	u32		   mnDieTvReadCounter;
